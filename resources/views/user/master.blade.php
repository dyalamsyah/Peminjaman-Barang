...
<head>
    ...
    <!-- Sticky Footer Fix CSS -->
    <link href="{{ asset('landingPage/css/sticky-footer.css') }}" rel="stylesheet">
</head>
    ...
    <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="{{ route('user.barang') }}" class="nav-item nav-link {{ request()->is('user/barang*') ? 'active' : '' }}">Barang</a>
                        <a href="{{ route('user.transaksi') }}" class="nav-item nav-link {{ request()->is('user/transaksi*') ? 'active' : '' }}">Riwayat</a>
                    ...
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                            @csrf
                            <button type="submit" class="btn btn-light px-3 d-block d-lg-flex"
        ...
        <footer id="contact">
            <div class="footer-content">
                <ul class="socials">
                    <li><a href="mailto:info@kebunraya.id"><i class="fa-regular fa-envelope"></i>info@kebunraya.id</a></li>
                    <li><a href="tel:+6281197115933"><i class="fa-solid fa-phone"></i>(0368)2033211</a></li>
                    <li><a href="https://maps.app.goo.gl/Yxqef2AsJyx2zPBE9"><i class="fa-solid fa-location-dot"></i>Jl. Kebun Raya, Candikuning, Bali 82191</a></li>
                </ul>
            </div>
        </footer>
        <!-- Footer End -->
